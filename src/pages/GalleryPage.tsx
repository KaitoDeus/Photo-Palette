...
import img1 from "../assets/examples/1.webp";
import img2 from "../assets/examples/2.webp";
import img3 from "../assets/examples/3.webp";
import img4 from "../assets/examples/4.webp";
import img5 from "../assets/examples/5.webp";
import img6 from "../assets/examples/6.webp";
import img7 from "../assets/examples/7.webp";
import img8 from "../assets/examples/8.webp";
import img9 from "../assets/examples/9.webp";
import img10 from "../assets/examples/10.webp";
import img11 from "../assets/examples/11.webp";
import img12 from "../assets/examples/12.webp";
import img13 from "../assets/examples/13.webp";
import img14 from "../assets/examples/14.webp";
import img15 from "../assets/examples/15.webp";
import img16 from "../assets/examples/16.webp";
import img17 from "../assets/examples/17.webp";
import img18 from "../assets/examples/18.webp";
import img19 from "../assets/examples/19.webp";
import img20 from "../assets/examples/20.webp";
import img21 from "../assets/examples/21.webp";
import img22 from "../assets/examples/22.webp";
import img23 from "../assets/examples/23.webp";
import img24 from "../assets/examples/24.webp";
...
const GalleryPage: React.FC = () => {
  ...
  const handleNext = useCallback((e?: React.MouseEvent) => {
    ...
    setSelectedIndex((prev) =>
      prev !== null ? (prev + 1) % MOMENTS.length : null,
    );
  }, []);
  ...
  const handlePrev = useCallback((e?: React.MouseEvent) => {
    e?.stopPropagation();
    setSelectedIndex((prev) =>
      prev !== null ? (prev - 1 + MOMENTS.length) % MOMENTS.length : null,
    );
  }, []);
