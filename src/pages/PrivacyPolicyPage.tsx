        ...
        <Reveal className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-brand-100">
          ...
          <div className="space-y-8 text-slate-600 leading-relaxed">
            <section>
              ...
              <p>
                Photo Palette là một phần mềm được xây dựng và phát
                triển bởi Võ Anh Khải 
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  ...
                  dự án này có thể được mình tham khảo từ các nguồn mở trên mạng
                </li>
                <li>
                  Hình ảnh mẫu được sử dụng để làm ví dụ minh họa trên trang web. Nếu 
                  không muốn hình ảnh xuất hiện tại đây, vui lòng liên hệ với
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-2">
                ...
                <li>
                  Hệ thống sẽ không lưu lại, không tải lên hay
                  chia sẻ bất cứ bức ảnh nào của bạn.
                </li>
                <li>
                  Chỉ cần tắt trang web thì mọi dữ liệu hình ảnh sẽ tự động xóa bỏ hoàn toàn.
                </li>
              </ul>
            </section>
