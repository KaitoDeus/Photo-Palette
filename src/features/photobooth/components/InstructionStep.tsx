      ...
      {permissionDenied ? (
        <div className="text-red-500">
          ...
          <div className="flex gap-4 justify-center">
               ...
               <Button onClick={onBack} variant="outline" className="border-red-200 text-red-500 hover:bg-red-50">Quay về</Button>
          </div>
        </div>
      ) : (
        <>
          <h3 className="text-2xl font-bold text-slate-900 mb-6">Sẵn Sàng Chưa?</h3>
          <div className={`bg-slate-900 rounded-2xl overflow-hidden shadow-xl mb-6 w-full relative mx-auto transition-all duration-500 ${getPreviewStyle()}`}>
            <video 
              ref={videoRef} 
              autoPlay 
              playsInline 
            ...
            <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center">
                ...
                >
                    <Video size={20} className={isRecapEnabled ? 'animate-pulse' : ''} />
          ...
          <div className="flex gap-3">
             <Button onClick={onBack} variant="secondary">Chọn lại</Button>
